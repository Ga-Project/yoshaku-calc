      ...
      <div className="sheet">
        ...
        <header className="plate">
          <div className="plate-brand">
            ...
            <span>
              {/* 文書の h1。銘板の見た目は .plate-word が全指定しているため変わらない。 */}
              <h1 className="plate-word">
        ...
        <div className="board" id="board">
          {/* 脇: 型紙の指定パネル */}
          {/* 見出しと aria-label が同文言で二重に読まれないよう、h2 を参照する */}
          <form
            className="spec"
            aria-labelledby="spec-head"
            onSubmit={(e) => e.preventDefault()}
          >
            <h2 className="spec-head" id="spec-head">
              型紙の指定
            </h2>
